...
Public Class FrmMain
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        AddPage(New UC_LastPurchases(Me), Pnl_Main)
        ...
        AddPage(New UC_CoffretsPossibles(Me), Pnl_Main)
        ...
        Menu_App.Items.Add("Derniers achats", GetType(UC_LastPurchases).FullName, My.Resources.menu_last_purchases)
        ...
        Menu_App.Items.Add("Coffrets possibles", GetType(UC_CoffretsPossibles).FullName, My.Resources.menu_statistics)
