...
Namespace BO
    ...
    Public MustInherit Class BoEditor
        ...
        Private m_fieldsNames As String() = {"Id", "Name", "WebSite", "Nationality", "FoundationDate", "CessationYear", "CessationCause", "LegalForm", "Status", "HeadOffice"}

        Dim m_Name As String
        Dim m_WebSite As String
        Dim m_Nationality As String
        Dim m_FoundationDate As DateTime
        Dim m_CessationYear As DateTime
        ...
        Public Function GetFoundationDate() As DateTime
            Return m_FoundationDate
        End Function
        Public Sub SetFoundationDate(p_FoundationDate As DateTime)
            m_FoundationDate = p_FoundationDate
        End Sub

        Public Function GetCessationYear() As DateTime
            Return m_CessationYear
        End Function
        Public Sub SetCessationYear(p_CessationYear As DateTime)
